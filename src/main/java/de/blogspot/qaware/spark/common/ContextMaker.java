package de.blogspot.qaware.spark.common;
...
public final class ContextMaker {
     ...
     */
    public static JavaSparkContext makeJavaSparkContext(String appName) {
        SparkConf conf = makeSparkConfig(appName);
    ...
    /**
     * Creates a Spark config with minimal necessary configuration.
     *
     * @param appName the name used for this Task.
     * @return a minimal SparkConf setup.
     */
    public static SparkConf makeSparkConfig(String appName) {
